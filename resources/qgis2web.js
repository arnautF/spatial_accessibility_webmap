...
map.getView().fit([2258456.895076, 5570213.061196, 2302263.171058, 5603118.824448], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Spatial accessibility to various facilities in Belgrade, Republic of Serbia</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (2213 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This is part of a research paper titled:<br /><br />"Spatial Modelling of Accessibility Areas in High- Density Cities: A Case Study of Belgrade, Republic of Serbia "<br /><br />Written by Filip Arnaut, Sreten Jevremović, Aleksandra Kolarski, Zoran Mijić and Vladimir A. Srećković<br /><br />of the Institute of Physics Belgrade, University of Belgrade, Pregrevica 118, Belgrade, Republic of Serbia<br /><br />Abstract of the manuscript:<br />This research conducted a spatial accessibility analysis for six facility groups located in the urban zone of Belgrade, Republic of Serbia. The examined facilities included primary healthcare centers, state-operated pharmacies (e.g., Pharmacy Belgrade), primary and secondary educational facilities, libraries, and green markets. The analysis indicated that roughly 246 thousand individuals do not have 15-minute walking access to a primary healthcare facility and their distribution in the analyzed area. The analysis revealed that approximately 89.5% of Belgrade\'s urban zone population has 15-minute walking access to an elementary school, excluding around 122 thousand individuals primarily situated at the periphery of the 15-minute accessibility zone across various sub-administrative units (SAU). Results were acquired for other facilities for time-travel intervals of 5, 10, and 15 minutes, and subsequent analysis ranked each SAU based on survey findings regarding the significance of proximity to these facilities from one’s residence. The three highest-ranked SAUs were Vračar, Zvezdara, and Stari Grad, while the three lowest were Resnik, Jajinci, and Višnjica. The significance of spatial accessibility analysis and modeling should be paramount, as it can constitute a vital element of data-driven decision-making and policy formulation as well as it can contribute to monitoring the development of various Sustainable Development Goals (SDGs). Spatial accessibility analysis and modeling can generate accessibility zones for various facilities and output the percentage of the population able to access these facilities within a specified timeframe. Subsequent research will focus on alternative facilities, other cities such as Novi Sad and Niš, and the disparity between urban and rural populations. ';
            }
